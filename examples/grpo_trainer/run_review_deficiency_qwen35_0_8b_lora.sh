#!/usr/bin/env bash
# =============================================================================
# GRPO + LoRA | Review Deficiency Classification | Qwen3.5-0.8B | Single GPU
#
...
#   bash examples/grpo_trainer/run_review_deficiency_qwen35_0_8B_lora.sh
#
# Overrides (env vars):
...
experiment_name=${EXPERIMENT_NAME:-qwen35_0_8B_lora_review_deficiency_$(date +%Y%m%d_%H%M)}
########################### end user-adjustable ###########################
